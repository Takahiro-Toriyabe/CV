...
Programming: Excel, Matlab, Python, R, Stata, SQL
...
\years{2022} ``Measurements of skill and skill-use using PIAAC,'' forthcoming in \textit{Labour Economics}, Co-author: Daiji Kawaguchi \\
...
\years{2022} ``Measurements of Skill and Skill-use using PIAAC,'' \textit{IZA Discussion Paper}, No.15177, Co-author: Daiji Kawaguchi \\
\years{2022} ``Are Japanese Wage Statistics Representative?'' \textit{CREPE Discussion Paper}, CREPEDP-115, Co-author: Daiji Kawaguchi \\
